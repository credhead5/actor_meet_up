...
Meeting.create!([
  {seeker_id: 2, fulfiller_id: 8, location: "Shetler Studios", start_time: DateTime.new, end_time: DateTime.new + 1.hour},
  {seeker_id: 3, fulfiller_id: 7, location: "Shetler Studios", start_time: DateTime.new, end_time: DateTime.new + 1.hour},
  {seeker_id: 4, fulfiller_id: 5, location: "Shetler Studios", start_time: DateTime.new, end_time: DateTime.new + 1.hour},
  {seeker_id: 5, fulfiller_id: 8, location: "Ripley Grier", start_time: DateTime.new, end_time: DateTime.new + 1.hour},
  {seeker_id: 2, fulfiller_id: 4, location: "Actor Connection", start_time: DateTime.new, end_time: DateTime.new + 1.hour},
  {seeker_id: 7, fulfiller_id: 2, location: "Yeoryia Studios", start_time: DateTime.new, end_time: DateTime.new + 1.hour},
